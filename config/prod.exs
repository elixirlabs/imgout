...
config :imgout,
  ...
  gm_pool_size: (System.get_env("GM_POOL_SIZE") || "25") |> String.to_integer,
  gm_pool_max_overflow: (System.get_env("GM_POOL_MAX_OVERFLOW") || "0") |> String.to_integer,
  gm_timeout: (System.get_env("GM_TIMEOUT") || "5000") |> String.to_integer,
  cache_pool_size: (System.get_env("CACHE_POOL_SIZE") || "50") |> String.to_integer,
  ...
  remote_storage_pool_size: (System.get_env("REMOTE_STORAGE_POOL_SIZE") || "50") |> String.to_integer,
